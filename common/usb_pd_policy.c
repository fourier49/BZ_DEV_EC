...
#ifndef BIZCFG_BILLBOARD_ALWAYS_CONNECT
...
void pd_usb_billboard_deferred(void)
{
	...
	{
		set_billboard_status(USB_SID_DISPLAYPORT, ALT_MODE_CONFIG_UNSUCCESS);
		usb_connect();
	}
...
void pd_usb_billboard_deferred(void)
{
	...
	if (!pd_alt_mode(0, USB_SID_DISPLAYPORT))
		...
		set_billboard_status(USB_SID_DISPLAYPORT, ALT_MODE_CONFIG_SUCCESS);
...
#endif /* end of BIZCFG_BILLBOARD_ALWAYS_CONNECT */
