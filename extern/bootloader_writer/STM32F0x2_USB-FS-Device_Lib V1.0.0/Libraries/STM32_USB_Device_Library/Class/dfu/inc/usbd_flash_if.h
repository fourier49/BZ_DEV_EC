...
//For bootloader writer, we allow first 64K is Readable, Erasable and Writeable(g). 
//and following 64K is readable.(a)
/*
a (0x41): Readable
b (0x42): Erasable
...
*/
#define FLASH_IF_STRING    (uint8_t*) "@Internal Flash   /0x08000000/64*001Kg,64*001Ka"  
