...
#define OPERATION_REBOOT		5
#define OPERATION_UPBLDRR		6


#define REBOOT_FLAG_SET_DFU				(1<<0)
#define REBOOT_FLAG_CLEAR_DFU			(1<<1)
#define REBOOT_FLAG_SET_SIGVERIFY		(1<<2)
#define REBOOT_FLAG_CLEAR_SIGVERIFY		(1<<3)
#define REBOOT_FLAG_SKIP_SIGVERIFY		(1<<4)
...
typedef struct {
	...
	int			RebootFlag;//boot flag for enter dfu 
