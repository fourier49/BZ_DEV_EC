#ifndef _BIZLINKDEVICE_H_
#define _BIZLINKDEVICE_H_
...
class CBIZLinkDevice : public CObject
{
public:
	DECLARE_DYNCREATE(CBIZLinkDevice)
	CBIZLinkDevice(CString sSymbolicName);
	~CBIZLinkDevice();
public:
	// Connection state
	DWORD Open(PHANDLE);
