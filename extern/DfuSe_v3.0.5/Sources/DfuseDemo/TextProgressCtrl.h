...
protected:
	...
	//}}AFX_MSG
    afx_msg LRESULT OnSetText(WPARAM wParam, LPARAM lParam);//(UINT, LPCTSTR szText);
    afx_msg LRESULT OnGetText(WPARAM wParam, LPARAM lParam);//(UINT cchTextMax, LPTSTR szText);
